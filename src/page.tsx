    ...
    <div className="flex min-h-screen flex-col">
      <header
        className={cn(
          ...
          "bg-gradient-to-r from-purple-500/5 via-blue-500/5 to-pink-500/5",
      ...
      <main className="flex-1">
        {/* Hero Section */}
        <section className="container bg-gradient-to-br from-purple-500/5 via-blue-500/5 to-pink-500/5 px-4 py-12 md:py-24 lg:py-32">
        ...
        <section
          id="features"
          className="container space-y-12 bg-gradient-to-tr from-purple-500/5 via-blue-500/5 to-pink-500/5 px-4 py-12 md:py-24 lg:py-32"
        >
        ...
        <section
          id="benefits"
          className="container space-y-12 bg-muted/50 bg-gradient-to-bl from-purple-500/5 via-blue-500/5 to-pink-500/5 px-4 py-12 md:py-24 lg:py-32"
        >
          <div className="flex flex-col items-center gap-4 text-center">
        ...
        {/* CTA Section */}
        <section className="container bg-muted px-4 py-12 md:py-24 lg:py-32">
          <div className="flex flex-col items-center gap-4 text-center">
            <h2 className="text-3xl font-bold tracking-tighter sm:text-4xl md:text-5xl">
